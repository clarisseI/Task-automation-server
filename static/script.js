document.addEventListener("DOMContentLoaded", () => {
  const BASE_URL = 'https://9b60-192-135-79-83.ngrok-free.app'; // Replace if ngrok changes
  ...
  // Live-clear errors when user changes fields
  ...
  // Fetch available tasks and populate categories/tasks
